...
var FloatingButtonComponent = (function () {
    function FloatingButtonComponent() {
    }
    FloatingButtonComponent.prototype.ngOnInit = function () {
    };
    FloatingButtonComponent.prototype.onClick = function () {
        $('.fabGrid').toggleClass('fabX');
    };
    FloatingButtonComponent = __decorate([
        core_1.Component({
            moduleId: module.id,
